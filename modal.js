/**
 * MODAL.JS - Handles the Premium Business Pop-ups
 */

function openFullModal(bizName) {
    // Find the business in the data we already fetched
    ...
    // Format the town for the color bar
    ...
    content.innerHTML = `
        ...
        <div class="town-bar ${townClass}-bar" style="margin: 15px -30px; border-radius: 0;">
            ${town}
        </div>
        ...
        <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(280px, 1fr)); gap:25px; margin-top: 20px;">
            <div>
                ...
                <p><strong>📍 Address:</strong> ${biz.address || 'N/A'}</p>
            ...
            <div>
                <h3>Map</h3>
                <iframe width="100%" height="250" frameborder="0" style="border:1px solid #ddd; border-radius:8px;" 
    ...
    setupModalClose(); // Re-bind close events
}
